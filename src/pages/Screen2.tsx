        ...
        <section className="block" style={{ overflow: 'hidden' }}>
          ...
          {cur.has3a && (
            <>
              ...
              {!cur.hasPK && cur.employmentStatus !== 'selfEmployed' && cur.yearly3a > CONSTANTS.PK_3A_MAX_WITHOUT_PK && (
                <div style={{ marginTop: 10, padding: '10px 12px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 8, fontSize: 12.5, color: '#991b1b' }}>
                  ⚠ <strong>Achtung Maximum überschritten:</strong> Das steuerlich abzugsfähige Maximum ohne PK beträgt CHF {fmtCHF(CONSTANTS.PK_3A_MAX_WITHOUT_PK)}/Jahr (2026). Einzahlungen darüber sind nicht steuerlich absetzbar.
                </div>
              )}
