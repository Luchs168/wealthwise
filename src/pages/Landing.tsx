        ...
        <div className="hero">
          <div>
            ...
            <div style={{
              ...
              borderRadius: 8, fontSize: 12, color: 'var(--navy-700)',
              display: 'flex', alignItems: 'center', gap: 8,
            }}>
              <span style={{ fontSize: 15 }}>🎓</span>
              <span>
                <strong>Prototyp – Masterarbeit MAS Information Systems Management, FHNW 2026</strong>
                <br />
                <span style={{ fontSize: 11, color: 'var(--ink-400)' }}>Keine Finanzberatung · Nur lokale Datenspeicherung</span>
              </span>
            </div>
